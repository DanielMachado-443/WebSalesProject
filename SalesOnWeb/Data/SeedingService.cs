...
using SalesOnWeb.Models.Enums;

namespace SalesOnWeb.Data {
    public class SeedingService {

        private SalesOnWebContext _context; // <<< Dependency Injection

        public SeedingService(SalesOnWebContext context) {
            _context = context;
        }

        public void Seed() {                 // <<<<<<<<<<<<<<< LOOK BACK TO IT
